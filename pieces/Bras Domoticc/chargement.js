...
materialLoader.load("./pieces/Bras Domoticc/bras.mtl", function(materials)
	{
	    	materials.preload();
		var objLoader = new THREEJS.OBJLoader();
		objLoader.setMaterials(materials); // Affecte (d'avance) le matériau
		objLoader.load('./pieces/Bras Domoticc/bras.obj', function ( object ) {
					PIECE = object;
					...
					PIECE.children[0].geometry.translate(0.6,0,-0.15)
