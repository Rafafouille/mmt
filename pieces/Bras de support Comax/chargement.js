...
materialLoader.load("./pieces/Bras de support Comax/support_comax.mtl", function(materials)
	{
	    	materials.preload();
		var objLoader = new THREEJS.OBJLoader();
		objLoader.setMaterials(materials); // Affecte (d'avance) le matériau
		objLoader.load('./pieces/Bras de support Comax/support_comax.obj', function ( object ) {
					PIECE = object;
